...
const ContentOne = () => (
    <>
        <ContentLayout 
            ...
            text=
    {`
    Simply put, web monetisation refers to the process of turning web traffic (i.e. site visits) into a revenue stream. Online, we are surrounded by various models of
    web monetisation, from advertising, to subscription sign-ups, to the selling of the data collected about site visitors, to the sale
    ...
    The model above comes from an organisation spearheading this experimentation, an independently managed fund called [Grant for the Web
    (https://www.grantfortheweb.org/faq)(GftW) created by Coil, Mozilla and Creative Commons. In addition to funding independent research into web monetisation such as
    this report, GftW are funding people’s experiments in applying this model through the Web Monetization API (a specific web application for adding the above model
    to a site).
    `}
        />
    </>
